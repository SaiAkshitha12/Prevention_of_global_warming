<%@ Page Language="C#" MasterPageFile="~/NGO/NGOMasterPage.master" AutoEventWireup="true" CodeFile="frmNGOChatRoom.aspx.cs" Inherits="AgricultureOfficer_frmOffricerChatRoom" Title="Untitled Page" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                     ...
                     <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="" />
                        ...
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                <td><b>NGO available to chat</b></td>
                                </tr>
                                <tr>
                                 ...
                                 <tr>
                                <td><b>Members available to chat</b></td>
                                </tr>
                                <tr>
                                    <td align="left" style="text-align: center">
