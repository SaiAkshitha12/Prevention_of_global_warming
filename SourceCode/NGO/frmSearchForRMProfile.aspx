<%@ Page Language="C#" MasterPageFile="~/NGO/NGOMasterPage.master" Theme="Theme1"  AutoEventWireup="true" CodeFile="frmSearchForRMProfile.aspx.cs" Inherits="NGO_frmSearchForRMProfile" Title="Untitled Page" %>
...
<ItemTemplate>*
<asp:LinkButton ID="lnkGM" ForeColor="#3366FF" runat ="server" Text='<%#Eval("FName") %>' CommandArgument='<%#Eval("MemberId") %>'></asp:LinkButton>
</ItemTemplate>
</asp:DataList></td>
</tr>
</table>
 ...
 <fieldset id="Field2" runat="server" style="border-style: groove; border-color: #996633;
            ...
            <table>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtWorking" runat="server" ReadOnly ="true" >Student</asp:TextBox>
                    </td>
