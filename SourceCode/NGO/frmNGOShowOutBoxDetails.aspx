<%@ Page Language="C#" Theme="Theme1"  MasterPageFile="~/NGO/NGOMasterPage.master" AutoEventWireup="true" CodeFile="frmNGOShowOutBoxDetails.aspx.cs" Inherits="AgricultureOfficer_frmOfficersShowOutBoxDetails" Title="Untitled Page" %>
...
<legend>Display OutBox Details</legend>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <td align=left>
            <h4>
           <a href="frmNGOOutBox.aspx" >Back</a>
             </h4>
            </td>
            </tr>
            <tr>
