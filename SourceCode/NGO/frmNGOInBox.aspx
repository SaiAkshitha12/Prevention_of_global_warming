<%@ Page Language="C#" Theme="Theme1"  MasterPageFile="~/NGO/NGOMasterPage.master" AutoEventWireup="true" CodeFile="frmNGOInBox.aspx.cs" Inherits="AgricultureOfficer_frmOfficersInBox" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentBody" Runat="Server">
    <center>
<h3 style="text-decoration: underline; text-align: center">NGO Mail Inbox</h3>
