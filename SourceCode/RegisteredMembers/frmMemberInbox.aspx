<%@ Page Language="C#" MasterPageFile="~/RegisteredMembers/MemberMasterPage.master" Theme="Theme1"  AutoEventWireup="true" CodeFile="frmMemberInbox.aspx.cs" Inherits="Students_frmStudentInbox" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentBody" Runat="Server">
    <center>
<h3 style="text-decoration: underline; text-align: center">Mamber Mail Inbox</h3>
            ...
            <ContentTemplate>
                ...
                <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
                    <tr>
                        ...
                        <tr>
                        <td>
                        <asp:Button ID="btnInbox" runat ="server" PostBackUrl="~/RegisteredMembers/frmMemberInbox.aspx" CausesValidation="false" Text="Inbox" />
            <asp:Button ID="btnOutBox" runat ="server" CausesValidation="false" PostBackUrl ="~/RegisteredMembers/frmMemberOutBox.aspx"  Text="OutBox" />
            <asp:Button ID="btnCompose" runat ="server" CausesValidation ="false" Text="Compose" PostBackUrl="~/RegisteredMembers/frmMemberComposeMails.aspx" />
