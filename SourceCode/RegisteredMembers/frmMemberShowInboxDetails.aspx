<%@ Page Language="C#" MasterPageFile="~/RegisteredMembers/MemberMasterPage.master" Theme="Theme1" AutoEventWireup="true" CodeFile="frmMemberShowInboxDetails.aspx.cs" Inherits="Students_frmStudentsShowInboxDetails" Title="Untitled Page" %>
...
<legend>Read Your Mails</legend>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <td align="left">
            <h4>
             <a href="frmMemberInbox.aspx">Back</a>
             </h4>
            </td>
            </tr>
            <tr>
