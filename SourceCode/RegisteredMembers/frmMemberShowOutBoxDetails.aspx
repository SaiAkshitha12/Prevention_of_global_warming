<%@ Page Language="C#" MasterPageFile="~/RegisteredMembers/MemberMasterPage.master" Theme="Theme1"  AutoEventWireup="true" CodeFile="frmMemberShowOutBoxDetails.aspx.cs" Inherits="Students_frmStudentsShowOutBoxDetails" Title="Untitled Page" %>
...
<legend>Display OutBox Details</legend>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <td align=left>
            <h4>
           <a href="frmMemberOutBox.aspx" >Back</a>
             </h4>
            </td>
            </tr>
            <tr>
