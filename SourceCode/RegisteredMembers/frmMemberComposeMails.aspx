<%@ Page Language="C#" MasterPageFile="~/RegisteredMembers/MemberMasterPage.master" Theme="Theme1" AutoEventWireup="true" CodeFile="frmMemberComposeMails.aspx.cs" Inherits="Students_frmStudentComposeMails" Title="Untitled Page" %>
...
<table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <tr>
            <td><asp:Button ID="btnInbox" runat ="server" PostBackUrl="~/RegisteredMembers/frmMemberInbox.aspx" CausesValidation="false" Text="Inbox" />
