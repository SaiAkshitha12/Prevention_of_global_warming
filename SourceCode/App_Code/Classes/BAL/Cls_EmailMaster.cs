...
public class Cls_EmailMaster
{
    ...
    public static DataSet ShowNGOEmails()
    {
        try
        {
            DataSet ds = new DataSet();
            return SqlHelper.ExecuteDataset(clsConnection.ConnectionString, CommandType.StoredProcedure, "sp_GetNGOMailsId");
        }
        catch (Exception ex)
        {
    ...
    public static DataSet ShowMemberEmails()
    {
        ...
        {
            DataSet ds = new DataSet();
            return SqlHelper.ExecuteDataset(clsConnection.ConnectionString, CommandType.StoredProcedure, "SP_ShowMemberMailId");
        }
        catch (Exception ex)
        {
    ...
    public static DataSet ShowNGOEmailsMemberWise(int id)
    {
        try
        {
            DataSet ds = new DataSet();
    ...
    public static DataSet ShowMemberEmailsNGOWise(int id)
    {
        try
        {
            DataSet ds = new DataSet();
            SqlParameter p = new SqlParameter("@NGOId", id);
