<%@ Page Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" Theme="Theme1"  CodeFile="frmNGOMasterInsert.aspx.cs" Inherits="frmNGOMasterInsert" Title="Untitled Page" %>
...
<center>
<h3 style="text-decoration: underline">NGO Registration Form</h3>
...
<tr>
<td>Working</td><td><asp:TextBox ID="txtWorking" runat ="server" Width ="181px"  ></asp:TextBox></td><td><asp:RequiredFieldValidator ID="RFVWorking" runat ="server" ControlToValidate ="txtWorking" ErrorMessage ="*"></asp:RequiredFieldValidator></td>
<td></td>
<td>Experience</td><td><asp:TextBox ID="txtExperience" runat ="server" Width="181px" ></asp:TextBox></td><td><asp:RequiredFieldValidator ID="RFVExperience" ErrorMessage ="*" runat ="server" ControlToValidate ="txtExperience" ></asp:RequiredFieldValidator></td>
</tr>
...
<td><asp:Button ID="btnSubmit" runat ="server" Text="Submit" 
        onclick="btnSubmit_Click" OnClientClick="return confirm('Are You Sure all the details are Correct!')" /><asp:Button ID="btnClear" runat ="server" 
